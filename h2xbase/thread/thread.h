...
#ifndef H2XBASE_THREAD_THREAD_H_
#define H2XBASE_THREAD_THREAD_H_
...
H2XBASE_EXPORT void setThreadName(DWORD thread_id, const char* name);
#endif

}

#endif  // H2XBASE_THREAD_THREAD_H_