...
class H2XBASE_EXPORT FrameworkThread : public virtual h2x::SupportWeakCallback, public h2x::Thread {
...
protected:
	...
	virtual void leanUpAfterMessageLoopDestruction() {}
...
#endif  // H2XBASE_THREAD_FRAMEWORK_THREAD_H_