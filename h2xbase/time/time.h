#ifndef H2XBASE_TIME__H
#define H2XBASE_TIME__H
...
class H2XBASE_EXPORT TimeDelta
{
public:
	TimeDelta() : delta_(0) {}
...
public:
	...
	struct H2XBASE_EXPORT TimeStruct
	{
...
class H2XBASE_EXPORT TimeTicks
{
public:
	TimeTicks() : ticks_(0) {}
