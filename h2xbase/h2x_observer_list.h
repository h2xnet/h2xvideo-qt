#ifndef H2XBASE_OBSERVER_LIST_H_
#define H2XBASE_OBSERVER_LIST_H_
...
namespace h2x {
    ...
    class H2XBASE_EXPORT LazyEraser
    {
    public:
    ...
    class H2XBASE_EXPORT ObserverList : public LazyEraser
    {
    public:
...
#endif // H2XBASE_OBSERVER_LIST_H_
